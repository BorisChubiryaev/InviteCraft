...
import {
  Sparkles, Clock, MapPin, Image, Heart, Send, Palette,
  ArrowRight, Star, Zap, Shield, Globe
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  const features = [
    { icon: Palette, title: 'Красивые шаблоны', desc: 'Выберите из коллекции профессионально разработанных шаблонов' },
    { icon: Clock, title: 'Обратный отсчёт', desc: 'Автоматический таймер до вашего мероприятия' },
    { icon: MapPin, title: 'Яндекс Карта', desc: 'Интерактивная карта с местом проведения' },
    { icon: Image, title: 'Фотогалерея', desc: 'Покажите ваши лучшие фотографии' },
    { icon: Send, title: 'RSVP онлайн', desc: 'Гости подтвердят участие прямо на сайте' },
    { icon: Heart, title: 'Полная кастомизация', desc: 'Настройте цвета, шрифты и содержание' },
  ];

  const steps = [
    { num: '01', title: 'Выберите шаблон', desc: 'Подберите дизайн, подходящий под стиль вашего мероприятия' },
    { num: '02', title: 'Настройте под себя', desc: 'Добавьте фото, текст, детали и настройте цвета' },
    { num: '03', title: 'Опубликуйте', desc: 'Поделитесь ссылкой с гостями одним кликом' },
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 border border-indigo-100 rounded-full mb-8 animate-fade-in-up">
            ...
            <span className="text-sm text-indigo-600 font-medium">Создайте идеальное приглашение за 5 минут</span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in-up delay-100" style={{ animationFillMode: 'both' }}>
            Ваше мероприятие —{' '}
          ...
          <p className="text-xl text-gray-500 mb-10 max-w-2xl mx-auto animate-fade-in-up delay-200" style={{ animationFillMode: 'both' }}>
            Конструктор красивых сайтов-приглашений для свадеб, дней рождения
            и любых особенных событий
          </p>
          ...
          {/* Stats */}
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 animate-fade-in-up delay-400" style={{ animationFillMode: 'both' }}>
            {stats.map((stat) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-indigo-500 uppercase tracking-wider">Просто и быстро</span>
            <h2 className="text-4xl font-bold text-gray-900 mt-3 mb-4">Как это работает</h2>
      ...
      {/* Templates */}
      <section id="templates" className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-indigo-500 uppercase tracking-wider">Коллекция</span>
            <h2 className="text-4xl font-bold text-gray-900 mt-3 mb-4">Шаблоны для любого события</h2>
            <p className="text-gray-500 text-lg max-w-xl mx-auto">
            ...
            {templates.map((tpl) => (
              ...
              >
                <div className={`h-48 bg-gradient-to-br ${tpl.previewGradient} flex items-center justify-center relative overflow-hidden`}>
                  <span className="text-6xl group-hover:scale-110 transition-transform duration-500">{tpl.previewEmoji}</span>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-indigo-500 uppercase tracking-wider">Возможности</span>
            <h2 className="text-4xl font-bold text-gray-900 mt-3 mb-4">Всё, что нужно для идеального приглашения</h2>
          </div>
